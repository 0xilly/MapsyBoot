...
public class MethodName {
    ...
    public void setObfDescriptor(String obfDesc) { obfDescriptor = obfDesc; }
    public void setMojang(String mojang) { this.mojang = mojang; }
    public void setMojangDescriptor(String desc) { mojangDescriptor = desc; }
    public void setSrg(String srg) { this.srg = srg; }
    public void setSrgDescriptor(String desc) { srgDescriptor = desc; }
    ...
    public MethodName fork() {
        MethodName mName = new MethodName();
        mName.setObf(getObf());
        mName.setObfDescriptor(getObfDescriptor());
        mName.setMojang(getMojang());
        mName.setMojangDescriptor(getMojang());
        mName.setSrg(getSrg());
        mName.setSrgDescriptor(getSrgDescriptor());
        mName.setMcp(getMcp());
        mName.setLocked(isLocked());
        mName.setDescription(getDescription());
        return mName;
    }
}
