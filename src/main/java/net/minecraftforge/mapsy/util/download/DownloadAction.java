package net.minecraftforge.mapsy.util.download;
 ...
 * <p>
 * The Spec {@link net.minecraftforge.mapsy.util.download.DownloadSpec}, Provides the specification for how things work.
 * <p>
 * The Action {@link DownloadAction}, What actually handles downloading
 * implements {@link net.minecraftforge.mapsy.util.download.DownloadSpec}, Useful for other tasks that need to download
 * something but not necessarily create an entire task to do said download.
 * <p>
 * implements {@link net.minecraftforge.mapsy.util.download.DownloadSpec} and hosts the Action as a task.
 * <p>
...
//                    }
    ...
    protected String loadETag(URL url) {
        ...
        try {
            return CollectionUtils.firstElement(Files.readAllLines(eTagFile));
        } catch (IOException e) {
